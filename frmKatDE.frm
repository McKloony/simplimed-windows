...
Select Case TabId
Case RibTab_Kat_EinDia: P_List "DiEi", GlDia(CmSu1.ListIndex, 0), 1
Case RibTab_Kat_KetDia: P_List "DiEi", 1, 2
End Select
...
DoEvents
Select Case TabId
Case RibTab_Kat_EinDia: KSuch "DiEi", GlDia(CmSu1.ListIndex, 0), 1
Case RibTab_Kat_KetDia: KSuch "DiEi", 1, 2
End Select
DoEvents
...
Case RibTab_Kat_EinDia:
            ...
            With GlSuE
                ...
                .SuStr = SuStr
            End With
            KSuch "DiEi", GlDia(CmSu1.ListIndex, 0), 1
            DoEvents
            If RpCo7.Records.Count = 0 Then
...
Select Case TabId
Case RibTab_Kat_EinDia: GlSuE = GlSuX
Case RibTab_Kat_KetDia: GlSuN = GlSuX
End Select
...
Private Sub FSpal()
On Error GoTo SpErr
'Stellt Spaltenbreiten und Spaltenposition Diagnosen ein
...
Case RibTab_Kat_EinDia:
        If GlPoK = True Then 'Popupkalender
            K_Kat1 "DiEi", , DroFe, EiDat
        Else
            K_Kat1 "DiEi", , DroFe, GlTag(1)
        End If
Case RibTab_Kat_KetDia:
...
Select Case TabId
Case RibTab_Kat_EinDia:
    TeTit = IniGetOpt("Hilfe", 50381)
    TeMai = IniGetOpt("Hilfe", 50382)
    TeInh = IniGetOpt("Hilfe", 50383)
    TeFus = IniGetOpt("Hilfe", 50384)
    SMeFr TeTit, TeMai, TeInh, TeFus, False, 1, True, Me.hwnd
Case RibTab_Kat_KetDia:
    If WindowLoad("frmKetten") = False Then
        TeTit = IniGetOpt("Hilfe", 50391)
        TeMai = IniGetOpt("Hilfe", 50392)
        TeInh = IniGetOpt("Hilfe", 50393)
        TeFus = IniGetOpt("Hilfe", 50394)
        SMeFr TeTit, TeMai, TeInh, TeFus, False, 1, True, Me.hwnd
    End If
End Select
...
Private Sub Form_Unload(Cancel As Integer)
    Set frmKatDE = Nothing
End Sub

Private Sub Form_Load()
    KMnRp "DiEi", True
    TabId = RibTab_Kat_EinDia
    FSpal
End Sub
