...
Case KA_Eint_MediAuf: FEinf 0 'Aufnahmemedikamente
Case KA_Eint_MediKra: FEinf 1 'Krankenblattmedikamente
Case KA_Eint_MediThe: FEinf 3 'Therapiekonzept
...
Select Case TabId
Case RibTab_Kat_EinMeK: P_List "KrMe", GlMed(CmSu1.ListIndex, 0), 1
Case RibTab_Kat_KetMeK: P_List "KrMe", 1, 2
End Select
...
DoEvents
Select Case TabId
Case RibTab_Kat_EinMeK: KSuch "KrMe", GlMed(CmSu1.ListIndex, 0), 1
Case RibTab_Kat_KetMeK: KSuch "KrMe", 1, 2
End Select
DoEvents
...
Case RibTab_Kat_EinMeK:
            ...
            With GlSuE
                ...
                .SuStr = SuStr
            End With
            KSuch "KrMe", GlMed(CmSu1.ListIndex, 0), 1
            DoEvents
            If RpCo7.Records.Count = 0 Then
...
Select Case TabId
Case RibTab_Kat_EinMeK: GlSuE = GlSuX
Case RibTab_Kat_KetMeK: GlSuN = GlSuX
End Select
...
Case RibTab_Kat_EinMeK:
        If GlPoK = True Then 'Popupkalender
            K_Kat1 "KrMe", , DroFe, EiDat
        Else
            K_Kat1 "KrMe", , DroFe, GlTag(1)
        End If
Case RibTab_Kat_KetMeK:
...
Select Case TabId
Case RibTab_Kat_EinMeK:
    TeTit = IniGetOpt("Hilfe", 50441)
    TeMai = IniGetOpt("Hilfe", 50442)
    TeInh = IniGetOpt("Hilfe", 50443)
    TeFus = IniGetOpt("Hilfe", 50444)
    SMeFr TeTit, TeMai, TeInh, TeFus, False, 1, True, Me.hwnd
Case RibTab_Kat_KetMeK:
    If WindowLoad("frmKetten") = False Then
        TeTit = IniGetOpt("Hilfe", 50451)
        TeMai = IniGetOpt("Hilfe", 50452)
        TeInh = IniGetOpt("Hilfe", 50453)
        TeFus = IniGetOpt("Hilfe", 50454)
        SMeFr TeTit, TeMai, TeInh, TeFus, False, 1, True, Me.hwnd
    End If
End Select
...
Private Sub Form_Unload(Cancel As Integer)
    Set frmKatKM = Nothing
End Sub
Private Sub Form_Load()
    KMnRp "KrMe", True
    TabId = RibTab_Kat_EinMeK
    FSpal
End Sub
