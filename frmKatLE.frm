...
Select Case TabId
Case RibTab_Kat_EinLab: P_List "LaEi", GlLab(CmSu1.ListIndex, 0), 1
Case RibTab_Kat_KetLab: P_List "LaEi", GlLab(CmSu2.ListIndex, 0), 2
End Select
...
DoEvents
Select Case TabId
Case RibTab_Kat_EinLab: KSuch "LaEi", GlLab(CmSu1.ListIndex, 0), 1
Case RibTab_Kat_KetLab: KSuch "LaEi", GlLab(CmSu2.ListIndex, 0), 2
End Select
DoEvents
...
Case RibTab_Kat_EinLab:
            ...
            With GlSuE
                ...
                .SuStr = SuStr
            End With
            KSuch "LaEi", GlLab(CmSu1.ListIndex, 0), 1
            DoEvents
            If RpCo7.Records.Count = 0 Then
...
Case RibTab_Kat_KetLab:
            ...
            With GlSuN
                ...
                .SuStr = SuStr
            End With
            KSuch "LaEi", GlLab(CmSu2.ListIndex, 0), 2
            DoEvents
            If RpCo7.Records.Count = 0 Then
                CmEd1.Text = vbNullString
                SPopu "Eintrag nicht gefunden", "Der von Ihnen gesuchte Eintrag, konnte nicht gefunden werden", IC48_Forbidden
...
Select Case TabId
Case RibTab_Kat_EinLab: GlSuE = GlSuX
Case RibTab_Kat_KetLab: GlSuN = GlSuX
End Select
...
Private Sub FSpal()
On Error GoTo SpErr
'Stellt Spaltenbreiten und Spaltenposition Laborleistungen ein
...
With RpCls
    ...
    Set RpCol = .Add(Kat_GOID, "Kennung", 80, False)
    With RpCol
...
Select Case TabId
Case RibTab_Kat_EinLab:
    TeTit = IniGetOpt("Hilfe", 50461)
    TeMai = IniGetOpt("Hilfe", 50462)
    TeInh = IniGetOpt("Hilfe", 50463)
    TeFus = IniGetOpt("Hilfe", 50464)
    SMeFr TeTit, TeMai, TeInh, TeFus, False, 1, True, Me.hwnd
Case RibTab_Kat_KetLab:
    If WindowLoad("frmKetten") = False Then
        TeTit = IniGetOpt("Hilfe", 50471)
        TeMai = IniGetOpt("Hilfe", 50472)
        TeInh = IniGetOpt("Hilfe", 50473)
        TeFus = IniGetOpt("Hilfe", 50474)
        SMeFr TeTit, TeMai, TeInh, TeFus, False, 1, True, Me.hwnd
    End If
End Select
...
Private Sub Form_Unload(Cancel As Integer)
    Set frmKatLE = Nothing
End Sub

Private Sub Form_Load()
    KMnRp "LaEi", True
    TabId = RibTab_Kat_EinLab
    FSpal
End Sub
