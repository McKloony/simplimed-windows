...
Case RibTab_Kat_EinMed: P_List "ArLi", GlArt(CmSu1.ListIndex, 0), 1
Case RibTab_Kat_KetMed: P_List "ArLi", 1, 2
End Select
...
DoEvents
Select Case TabId
Case RibTab_Kat_EinMed: KSuch "ArLi", GlArt(CmSu1.ListIndex, 0), 1
Case RibTab_Kat_KetMed: KSuch "ArLi", 1, 2
End Select
DoEvents
...
Case RibTab_Kat_EinMed:
            ...
            With GlSuE
                ...
                .SuStr = SuStr
            End With
            KSuch "ArLi", GlArt(CmSu1.ListIndex, 0), 1
            DoEvents
            If RpCo7.Records.Count = 0 Then
...
With RpCls
    ...
    With RpCol
        ...
        End If
    End With
    Set RpCol = .Add(Kat_IDKurz, "Bezeichnungstext", 400, False)
    If RpCo7.PaintManager.FixedRowHeight = False Then
...
Case RibTab_Rezeptmodul:
    Select Case TabId
    Case RibTab_Kat_EinMed: K_RzEi "ArLi"
    Case RibTab_Kat_KetMed: K_RzEi "ArLi", True
    End Select
End Select
...
Select Case TabId
Case RibTab_Kat_EinMed:
    TeTit = IniGetOpt("Hilfe", 50311)
    TeMai = IniGetOpt("Hilfe", 50312)
    TeInh = IniGetOpt("Hilfe", 50313)
    TeFus = IniGetOpt("Hilfe", 50314)
    SMeFr TeTit, TeMai, TeInh, TeFus, False, 1, True, Me.hwnd
Case RibTab_Kat_KetMed:
    If WindowLoad("frmKetten") = False Then
        TeTit = IniGetOpt("Hilfe", 50321)
        TeMai = IniGetOpt("Hilfe", 50322)
        TeInh = IniGetOpt("Hilfe", 50323)
        TeFus = IniGetOpt("Hilfe", 50324)
        SMeFr TeTit, TeMai, TeInh, TeFus, False, 1, True, Me.hwnd
    End If
End Select
