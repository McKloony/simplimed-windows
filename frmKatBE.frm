...
Select Case TabId
Case RibTab_Kat_EinBeg: P_List "BeEi", 3, 1
...
Select Case TabId
Case RibTab_Kat_EinBeg: GlSuE = GlSuX
Case RibTab_Kat_KetBeg: GlSuN = GlSuX
End Select
...
Public Sub FSpal()
On Error GoTo SpErr
'Stellt Spaltenbreiten und Spaltenposition Begründungen ein
...
With RpCls
    ...
    With RpCol
        ...
        End If
    End With
    Set RpCol = .Add(Kat_IDKurz, "Begründungstext", 400, False)
    If RpCo7.PaintManager.FixedRowHeight = False Then
...
TeTit = IniGetOpt("Hilfe", 50351)
TeMai = IniGetOpt("Hilfe", 50352)
TeInh = IniGetOpt("Hilfe", 50353)
TeFus = IniGetOpt("Hilfe", 50354)
...
Private Sub Form_Unload(Cancel As Integer)
    Set frmKatBE = Nothing
End Sub
Private Sub Form_Load()
    KMnRp "BeEi", True
    TabId = RibTab_Kat_EinBeg
    FSpal
End Sub
