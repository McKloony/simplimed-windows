...
Case KM_Vorschauzeile: KGrKa "GrdPrv"
...
GlKaE = False 'Expertensystem

Select Case TabId
Case RibTab_Kat_EinGeb: P_List "GbEi", GlGKa(CmSu1.ListIndex, 0), 1
Case RibTab_Kat_KetGeb: P_List "GbEi", GlGKa(CmSu2.ListIndex, 0), 2
End Select
...
DoEvents
Select Case TabId
Case RibTab_Kat_EinGeb: KSuch "GbEi", GlGKa(CmSu1.ListIndex, 0), 1
Case RibTab_Kat_KetGeb: KSuch "GbEi", GlGKa(CmSu2.ListIndex, 0), 2
End Select
DoEvents
...
Select Case TabId
Case RibTab_Kat_EinGeb: LiIdx = CmSu1.ListIndex
Case RibTab_Kat_KetGeb: LiIdx = CmSu2.ListIndex
End Select

Select Case TabId
Case RibTab_Kat_EinGeb: CmSu2.ListIndex = LiIdx
Case RibTab_Kat_KetGeb: CmSu1.ListIndex = LiIdx
End Select

Select Case TabId
Case RibTab_Kat_EinGeb: KSuch "GbEi", GlGKa(LiIdx, 0), 1
Case RibTab_Kat_KetGeb: KSuch "GbEi", GlGKa(LiIdx, 0), 2
End Select
...
Else
    ...
    GlFGE = False 'Favoriten Gebühren
    Select Case TabId
    Case RibTab_Kat_EinGeb:
            With GlSuE
                .SuIdx = 0
...
Select Case TabId
Case RibTab_Kat_EinGeb:
            SuStr = RTrim$(CmEd1.Text)
            With GlSuE
                .SuIdx = 1
                .SuStr = SuStr
            End With
            KSuch "GbEi", GlGKa(CmSu1.ListIndex, 0), 1
            DoEvents
            If RpCo7.Records.Count = 0 Then
            ...
            End If
Case RibTab_Kat_KetGeb:
            SuStr = RTrim$(CmEd2.Text)
            With GlSuN
                .SuIdx = 1
                .SuStr = SuStr
            End With
            KSuch "GbEi", GlGKa(CmSu2.ListIndex, 0), 2
            DoEvents
            If RpCo7.Records.Count = 0 Then
                CmEd1.Text = vbNullString
                SPopu "Eintrag nicht gefunden", "Der von Ihnen gesuchte Eintrag, konnte nicht gefunden werden", IC48_Forbidden
...
Select Case TabId
Case RibTab_Kat_EinGeb: GlSuE = GlSuX
Case RibTab_Kat_KetGeb: GlSuN = GlSuX
End Select
...
Private Sub FSpal()
On Error GoTo SpErr
'Stellt Spaltenbreiten und Spaltenposition Gebühren ein
...
With RpCls
    ...
    With RpCol
        ...
        End If
    End With
    Set RpCol = .Add(Kat_IDKurz, "Leistungstext", 400, False)
    If RpCo7.PaintManager.FixedRowHeight = False Then
    ...
    Set RpCol = .Add(Kat_Typ, "Typ", 0, False)
End With
...
Select Case TabId
Case RibTab_Kat_EinGeb:
    TeTit = IniGetOpt("Hilfe", 50401)
    TeMai = IniGetOpt("Hilfe", 50402)
    TeInh = IniGetOpt("Hilfe", 50403)
    TeFus = IniGetOpt("Hilfe", 50404)
    SMeFr TeTit, TeMai, TeInh, TeFus, False, 1, True, Me.hwnd
Case RibTab_Kat_KetGeb:
    If WindowLoad("frmKetten") = False Then
        TeTit = IniGetOpt("Hilfe", 50411)
        TeMai = IniGetOpt("Hilfe", 50412)
        TeInh = IniGetOpt("Hilfe", 50413)
        TeFus = IniGetOpt("Hilfe", 50414)
        SMeFr TeTit, TeMai, TeInh, TeFus, False, 1, True, Me.hwnd
    End If
End Select
...
If GlKaE = True Then 'Expertensystem
    If Row.GroupRow = False Then
        If Row.Index < UBound(GlKPo) Then
            If GlKPo(Row.Record.Index + 1) > 0 Then
                Metrics.Font.Bold = True
                Metrics.ForeColor = 51200
            End If
        End If
    End If
End If
...
Private Sub Form_Unload(Cancel As Integer)
    Set frmKatGE = Nothing
End Sub

Private Sub Form_Load()
    KMnRp "GbEi", True
    TabId = RibTab_Kat_EinGeb
    FSpal
End Sub
