...
Case KA_Eint_DiagDau: FEinf 0
Case KA_Eint_DiagTag: FEinf 1
Case KA_Eint_DiagVeAu: FEinf 3
Case KA_Eint_DiagZuNa: FEinf 4
...
Select Case TabId
Case RibTab_Kat_EinDiK: P_List "KrDi", GlDia(CmSu1.ListIndex, 0), 1
Case RibTab_Kat_KetDiK: P_List "KrDi", 1, 2
End Select
...
DoEvents
Select Case TabId
Case RibTab_Kat_EinDiK: KSuch "KrDi", GlDia(CmSu1.ListIndex, 0), 1
Case RibTab_Kat_KetDiK: KSuch "KrDi", 1, 2
End Select
DoEvents
...
Case RibTab_Kat_EinDiK:
            ...
            With GlSuE
                ...
                .SuStr = SuStr
            End With
            KSuch "KrDi", GlDia(CmSu1.ListIndex, 0), 1
            DoEvents
            If RpCo7.Records.Count = 0 Then
...
Select Case TabId
Case RibTab_Kat_EinDiK: GlSuE = GlSuX
Case RibTab_Kat_KetDiK: GlSuN = GlSuX
End Select
...
Private Sub FSpal()
On Error GoTo SpErr
'Stellt Spaltenbreiten und Spaltenposition Krankenblattdiagnosen ein
...
With RpCls
    ...
    Set RpCol = .Add(Kat_GOID, "ICD-Code", 80, False)
    With RpCol
        ...
        End If
    End With
    Set RpCol = .Add(Kat_IDKurz, "Diagnosetext", 400, False)
    If RpCo7.PaintManager.FixedRowHeight = False Then
...
Case RibTab_Kat_EinDiK:
        If GlPoK = True Then 'Popupkalender
            K_Kat1 "KrDi", , DroFe, EiDat
        Else
            K_Kat1 "KrDi", , DroFe, GlTag(1)
        End If
Case RibTab_Kat_KetDiK:
...
Select Case TabId
Case RibTab_Kat_EinDiK:
    TeTit = IniGetOpt("Hilfe", 50421)
    TeMai = IniGetOpt("Hilfe", 50422)
    TeInh = IniGetOpt("Hilfe", 50423)
    TeFus = IniGetOpt("Hilfe", 50424)
    SMeFr TeTit, TeMai, TeInh, TeFus, False, 1, True, Me.hwnd
Case RibTab_Kat_KetDiK:
    If WindowLoad("frmKetten") = False Then
        TeTit = IniGetOpt("Hilfe", 50431)
        TeMai = IniGetOpt("Hilfe", 50432)
        TeInh = IniGetOpt("Hilfe", 50433)
        TeFus = IniGetOpt("Hilfe", 50434)
        SMeFr TeTit, TeMai, TeInh, TeFus, False, 1, True, Me.hwnd
    End If
End Select
...
Private Sub Form_Unload(Cancel As Integer)
    Set frmKatKD = Nothing
End Sub
Private Sub Form_Load()
    KMnRp "KrDi", True
    TabId = RibTab_Kat_EinDiK
    FSpal
End Sub
